...
public class SpecialEntity extends ApplicationPersistenceEntity implements Special {
  ...
  public void setActivePeriod(WeeklyPeriod activePeriod) {
    ...
    if (activePeriod == null) {
      ...
      WeeklyPeriodEmbeddable embeddablePeriod = new WeeklyPeriodEmbeddable();
      embeddablePeriod.setStartingDay(activePeriod.getStartingDay());
      embeddablePeriod.setStartingHour(activePeriod.getStartingHour());
      embeddablePeriod.setEndingDay(activePeriod.getEndingDay());
      embeddablePeriod.setEndingHour(activePeriod.getEndingHour());
      this.activePeriod = embeddablePeriod;
    }
  }
